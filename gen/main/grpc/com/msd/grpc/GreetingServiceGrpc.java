...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.msd.grpc.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest,
      com.msd.grpc.GreetingResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = com.msd.grpc.GreetingRequest.class,
      responseType = com.msd.grpc.GreetingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest,
      com.msd.grpc.GreetingResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest, com.msd.grpc.GreetingResponse> getGreetMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetMethod = GreetingServiceGrpc.getGreetMethod) == null) {
          GreetingServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<com.msd.grpc.GreetingRequest, com.msd.grpc.GreetingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msd.grpc.GreetingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msd.grpc.GreetingResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest,
      com.msd.grpc.GreetingResponse> getGreetManyMethod;
  ...
  public static io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest,
      com.msd.grpc.GreetingResponse> getGreetManyMethod() {
    io.grpc.MethodDescriptor<com.msd.grpc.GreetingRequest, com.msd.grpc.GreetingResponse> getGreetManyMethod;
    if ((getGreetManyMethod = GreetingServiceGrpc.getGreetManyMethod) == null) {
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetManyMethod = GreetingServiceGrpc.getGreetManyMethod) == null) {
          GreetingServiceGrpc.getGreetManyMethod = getGreetManyMethod =
              io.grpc.MethodDescriptor.<com.msd.grpc.GreetingRequest, com.msd.grpc.GreetingResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.msd.grpc.GreetingResponse.getDefaultInstance()))
              .setSchemaDescriptor(new GreetingServiceMethodDescriptorSupplier("GreetMany"))
              .build();
        }
      }
    }
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greet(com.msd.grpc.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.msd.grpc.GreetingResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGreetMethod(), responseObserver);
    }

    /**
     */
    public void greetMany(com.msd.grpc.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.msd.grpc.GreetingResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGreetManyMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.msd.grpc.GreetingRequest,
                com.msd.grpc.GreetingResponse>(
                  this, METHODID_GREET)))
          .addMethod(
            getGreetManyMethod(),
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.msd.grpc.GreetingResponse greet(com.msd.grpc.GreetingRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.msd.grpc.GreetingResponse> greetMany(
        com.msd.grpc.GreetingRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.msd.grpc.GreetingResponse> greet(
        com.msd.grpc.GreetingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((com.msd.grpc.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.msd.grpc.GreetingResponse>) responseObserver);
          break;
        case METHODID_GREET_MANY:
          serviceImpl.greetMany((com.msd.grpc.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.msd.grpc.GreetingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.msd.grpc.GreetingOuterClass.getDescriptor();
    }
